...
export default function InspectorListing() {
  ...
  return (
    <div className="p-3 sm:p-5 lg:p-7 min-h-screen bg-slate-50">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-800 tracking-tight">Inspector Records</h1>
          <p className="text-slate-500 text-sm mt-0.5">Trip inspection checks recorded by ETM devices</p>
        </div>
      </div>
